...
public class KinectPlayer : MonoBehaviour
{
    ...
    private Vector3 _playerPositionOffset = new Vector3(0.0f,0.0f,0.0f);
    ...
    public GameObject GetBodyPart(JointType jt)
    {
       ...
       // Debug.Log(BodyTransforms[jt].gameObject+"test");
    }
    ...
    private void Update()
    {
        GameObject dude = GameObject.Find("offset");
        _playerPositionOffset =dude.transform.position;
       // Debug.Log(_playerPositionOffset);
    }
    ...
    public void UpdateBodyObject()
    {
        ...
        foreach (JointType jt in Kinect.UnessentialJoints)
        {
            ...
            if (jointObj != null)
            {
                jointObj.localPosition = BodyPositions[jt];// + new Vector3(0, 0.25f, 0);
            }
           

            l_leg.transform.localPosition = BodyPositions[JointType.KneeLeft];// + new Vector3(0, 0.75f, 0);
            r_leg.transform.localPosition = BodyPositions[JointType.KneeRight];// + new Vector3(0, 0.75f, 0);
        }
    }
